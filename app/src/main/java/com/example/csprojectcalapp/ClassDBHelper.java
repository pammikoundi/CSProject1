...
public class ClassDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase DB) {
        DB.execSQL("create Table Class_info(uniqueID_class TEXT primary key,className TEXT, classInstructor TEXT,classSection TEXT,classLocation TEXT,date TEXT,time TEXT,repeat TEXT)");
    ...
    //Class Data Methods
    public boolean insertClassData(String className , String classInstructor,String classSection,String classLocation,String date,String startTime,String endTime, String repeat) {
